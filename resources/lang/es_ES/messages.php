...
return [
    ...
    'edit_description' => 'Actualiza el contenido, precio y visibilidad de ":publication".',
    ...
    'media' => [
        'video_title' => 'Videos del portafolio',
        'audio_title' => 'Audio del portafolio',
        'open_video' => 'Abrir el video del portafolio',
        'open_audio' => 'Abrir el audio del portafolio',
        'play_audio' => 'Reproducir audio',
        'pause_audio' => 'Pausar audio',
        'seek_audio' => 'Desplazarse por el audio',
        'playback_speed' => 'Cambiar velocidad de reproducción',
    ],
    ...
    'fields' => [
        ...
        'video' => 'Videos del portafolio',
        'audio' => 'Archivos de audio del portafolio',
        'current_video' => 'Videos actuales',
        'current_audio' => 'Archivos de audio actuales',
    ...
    'help' => [
        ...
        'portfolio_external' => 'Envía a los visitantes a un portafolio alojado en otro sitio web.',
        'portfolio_images' => 'Muestra una galería de trabajos de referencia directamente en tu publicación.',
        'portfolio_video' => 'Muestra videos directamente en tu publicación.',
        'portfolio_audio' => 'Permite escuchar muestras de audio directamente en tu publicación.',
        'portfolio_url' => 'Solo se aceptan enlaces HTTP y HTTPS.',
        'images' => 'Sube hasta :count imágenes JPG, PNG o WebP de :size MB por archivo.',
        'video' => 'Sube hasta :count videos MP4 o WebM de :size MB por archivo.',
        'audio' => 'Sube hasta :count archivos MP3, WAV, OGG o M4A de :size MB por archivo.',
        'server_upload_limit' => 'Este servidor acepta actualmente archivos de hasta :server, mientras Seeker está configurado para :configured por archivo. El límite menor del servidor continúa aplicándose.',
        'server_file_count_limit' => 'PHP acepta hasta :server archivos por solicitud, mientras Seeker está configurado para :configured. El límite menor de PHP continúa aplicándose.',
        ...
        'remove_media' => 'Si eliminas todos los archivos, debes subir al menos un reemplazo.',
    ...
    'validation' => [
        ...
        'max_assets' => 'Una publicación puede contener hasta :count elementos de :type.',
        'asset_too_large' => 'Cada archivo puede pesar hasta :size MB.',
    ...
    'conversations' => [
        ...
        'empty_filtered' => 'No hay conversaciones que coincidan con esta vista.',
        'filters' => [
    ...
    'profiles' => [
        ...
        'profile_label' => 'Perfil de Seeker',
    ...
    'publication_reports' => [
        ...
        'title' => 'Reportar publicación de Seeker',
        'back' => 'Volver a la publicación',
        'reporting' => 'Estás reportando “:publication”.',
        'notice' => 'Moderación recibirá tu explicación y una copia del contenido de la publicación tal como aparece ahora.',
        'reason' => 'Motivo',
        'select_reason' => 'Selecciona un motivo',
        'details' => '¿Qué debe saber moderación?',
        'details_help' => 'Proporciona detalles específicos utilizando entre 20 y 2,000 caracteres.',
        'submit' => 'Enviar reporte',
        'sent' => 'El reporte de la publicación fue enviado a moderación de Seeker.',
        'already_sent' => 'Ya reportaste esta publicación.',
        'sent_badge' => 'Publicación reportada',
        'reasons' => [
            'spam' => 'Spam o promoción abusiva',
            'fraud' => 'Fraude o intento de estafa',
            'inappropriate' => 'Contenido inapropiado',
            'misleading' => 'Descripción o afirmaciones engañosas',
            'prohibited' => 'Servicio o actividad prohibida',
            'other' => 'Otro',
        ],
    ],
    'security' => [
