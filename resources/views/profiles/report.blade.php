        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="seeker-author-summary d-flex align-items-center gap-3 mb-4"><img src="{{ $user->getAvatar(56) }}" width="56" height="56" class="rounded-circle seeker-profile-avatar" alt=""><strong>{{ $user->name }}</strong></div>
