        ...
        <div class="col-xl-7">
            <div class="card seeker-admin-card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mt-3 mb-0">{{ \Illuminate\Support\Str::limit(app(\Azuriom\Plugin\Seeker\Services\PublicationMarkdown::class)->plainText($conversation->publication->description), 300) }}</p>
                </div>
            </div>
        </div>
        <div class="col-xl-5">
