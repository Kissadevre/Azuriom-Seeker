...
<div class="mb-4">
    ...
    <textarea id="publicationDescription" name="description" class="form-control font-monospace @error('description') is-invalid @enderror" rows="14" minlength="20" maxlength="50000" spellcheck="true" required>{{ old('description', $publication->description ?? '') }}</textarea>
